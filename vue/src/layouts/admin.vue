			...
			<div class="w-full h-full bg-[white] z-10 rounded-r-[4px] p-[10px] flex flex-col justify-between">
				<ul class="w-full flex flex-col gap-[10px]">
					<li>
						...
						<router-link 
						:to="{path: '/admin/guides'}"
						@click="isOpen = false" 
						class="no-underline hover:underline"
						>
							{{ $tr("layouts.admin.guides") }}
						</router-link>
					</li>
					...
					<li>
						...
						<router-link 
						:to="{path: '/admin/invits'}"
						@click="isOpen = false" 
						class="no-underline hover:underline"
						>
							{{ $tr("layouts.admin.invits") }}
						</router-link>
					</li>
